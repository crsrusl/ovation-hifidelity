<?php
function custom_technology_type()
{

    $labels = array(
        'name' => _x('Technology', 'Post Type General Name', 'text_domain'),
    ...
    $args = array(
        ...
        'description' => __('The technology post type', 'text_domain'),
        'labels' => $labels,
...
add_action('init', 'custom_technology_type', 0);